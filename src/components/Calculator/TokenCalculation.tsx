      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-100">
              {formatTokens(vestingSchedule.monthlyVesting)} $ENS per month
            </span>
          </div>
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3 mt-6">
        <div className="flex items-start">
          ...
          <div className="text-xs text-yellow-800 dark:text-yellow-200">
            <strong>Important:</strong> This calculation uses estimated pricing
            based on current data and projections. The actual token allocation
            will be determined using the true 6-month average ENS price from
            January 1 to July 1, 2025. All tokens vest linearly over 2 years
            beginning January 1, 2025, with distribution occurring July 1, 2025.
          </div>
        </div>
      </div>
    </div>
